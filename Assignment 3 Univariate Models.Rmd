...
Statistical analysis of the Acer rubrum disturbance model does not reveal statistical significance for any of the disturbance treatments. However, the disturbance treatment of "VIRGIN" yields statistical significance for Abies fraseri abundance, with ~21% variance explained. 
...
For Acer rubrum, changing the error distribution to poisson does not appear to change the apparent variance explained for either the A. rubrum main model of all variables or the A. rubrum ebs model of elev, beers, and streamdist alone. 
...
For Abies fraseri, changing the error distribution resulted in a higher R-squared value and more variance explained for a fraseri model including all variables, but did not significantly increase the R-squared value and variance explained for a fraseri model accounting for elevation variable alone. 
...
*Abies fraseri*
However, the analysis of the models for Abies fraseri abundance indicated that the variables of plot elevation and plot disturbance (specifically the "VIRGIN" treatment) were able to account for variance of A. fraseri abundance. As a result, the data appear to indicate that A. fraseri prefers undisturbed, high-elevation plots in order to proliferate. This is consistent with the fact that A. fraseri is a habitat specialist, as it requires this specific set of conditions in order to proliferate and compete with Acer rubrum. 
