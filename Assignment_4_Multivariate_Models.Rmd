...
Analysis of the above graphics suggests that the species Anthodor, Vicilath, Planlac, Trifprat, and Achimill likely occurr in similar sites (i.e. sites with Moisture index 1 and the 'BF' Management treatment). 
...
Of the individual variable models, the Moisture model yields the highest R-squared value and the lowest p-value. The plots of the results indicate that Trifprat, Achimill, Vicilath, Planlanc, and Anthodor are most losely associated with Moisture 1, as well as the 'BF' Management treatment. 
...
The two analyses agree with one another because they both show the differences in environmental distribution of Anthodor, Vicilath, Planlac, Trifprat, and Achimill to be closely tied to sites with Mosture 1 and Management BF. Specifically, the NMDS analysis shows that sites with Moisture 1 are relatively similar in terms of species composition and that Anthodor, Vicilath, Planlac, Trifprat, and Achimill are closely associated with these sites. The CCA analyses provides further evidence that these species are associated with Moisture 1 sites, but also shows that a correlation to the Management variable is possible in that they are also tied to sites associated with the Biological Farming management treatment. 
